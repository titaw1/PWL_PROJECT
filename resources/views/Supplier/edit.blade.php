	...
	<form method="POST" action="{{ route('supplier.update', $supplier->kode) }}" id="myForm">
		...
		<div class="form-group row">
			...
			<div class="col-sm-12 col-md-10">
                ...
                value="{{ $supplier->kode }}" aria-describedby="kode" placeholder readonly="">
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-12 col-md-10">
                ...
                value="{{ $supplier->nama }}" aria-describedby="nama" placeholder="">
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-12 col-md-10">
                ...
                value="{{ $supplier->alamat }}" aria-describedby="alamat" placeholder="">
			</div>
		</div>
        <div class="form-group row">
			...
			<div class="col-sm-12 col-md-10">
                ...
                value="{{ $supplier->telp }}" aria-describedby="telp" placeholder="">
			</div>
		</div>
        <div class="form-group row">
			...
			<div class="col-sm-12 col-md-10">
                ...
                value="{{ $supplier->kota }}" aria-describedby="kota" placeholder="">
			</div>
		</div>
        <div class="form-group row">
			...
			<div class="col-sm-12 col-md-10">
                ...
                value="{{ $supplier->penyedia }}" aria-describedby="penyedia" placeholder="">
			</div>
		</div>
		<div class="form-group row">
