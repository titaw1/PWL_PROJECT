    ...
    <div class="row">
        <div class="col-md-6 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('barang.index') }}">Barang Keluar</a></li>
...
<div class="pd-20 card-box mb-30">
	...
	<form method="POST" action="{{ route('BarangKeluar.update', $keluar->kode) }}" id="myForm" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input class="form-control" type="date" name="tgl_keluar" id="tgl_keluar" value="{{ date('Y-m-d', strtotime(Carbon\Carbon::today()->toDateString())) }}" aria-describedby="tgl_keluar" placeholder="">
            </div>
        </div>
        <br>
		<div class="form-group row">
